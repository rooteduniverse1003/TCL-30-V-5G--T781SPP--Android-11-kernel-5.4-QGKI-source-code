...
# Begin added by bitao.xiong for task-10700744 on 2021-02-03
ifeq ($(strip $(TARGET_BUILD_MMITEST)),true)
KBUILD_CFLAGS += -DTARGET_BUILD_MMITEST
endif

ifeq ($(strip $(TARGET_BUILD_HWTEST)),true)
KBUILD_CFLAGS += -DDISABLE_TEMPERATURE_DETECTION_AND_THERMAL_POLICY
endif
# End added by bitao.xiong for task-10700744 on 2021-02-03

# Begin added by weijun for certification on 2021-08-21
ifeq ($(strip $(TARGET_BUILD_CERTIFICATION)),true)
KBUILD_CFLAGS += -DDISABLE_TEMPERATURE_DETECTION_AND_THERMAL_POLICY
endif
# End added by weijun for certification on 2021-08-21

ifeq ($(strip $(TARGET_BUILD_ENDURANCE)),true)
KBUILD_CFLAGS += -DTARGET_BUILD_ENDURANCE
endif
#Add-start by baiwei.peng to define macro from enviroment variable
...
#Add-end by baiwei.peng to define macro from enviroment variable

#Begin added by jitao.bie for task-10794932  on 2021-03-7
ifeq ($(strip $(TARGET_TF_USERDEBUG)),true)
KBUILD_CFLAGS += -DTCT_SECURE_BOOT_FAILURE
endif
ifeq ($(strip $(TARGET_TF_ENG)),true)
KBUILD_CFLAGS += -DTCT_SECURE_BOOT_FAILURE
endif
ifeq ($(TARGET_BUILD_VARIANT),user)
KBUILD_CFLAGS += -DTCT_SECURE_BOOT_FAILURE
endif
# End added by jitao.bie for task-10794932  on 2021-03-7
...
# Begin modified by zongbao.ye.sz for tct feature
-include $(srctree)/../../out/target/common/tct_intermediates/feature/global_kernel.mk
# End modified by by zongbao.ye.sz for tct feature
