...
static const struct vadc_map_pt adcmap_batt_therm_30k[] = {
#if defined(CONFIG_TCT_HOLI_TRANSFORMERVZW)
        {1626,  -400},
        {1600,  -380},
        {1573,  -360},
        {1545,  -340},
        ...
        {65,    960},
        {62,    980}
#elif defined(CONFIG_TCT_HOLI_IRVINEVZW)
        {1673,  -400},
        {1649,  -380},
        {1623,  -360},
        {1596,  -340},
        ...
        {66 ,    960},
        {63 ,    980}
#elif defined(CONFIG_TCT_HOLI_BREMENTF) || defined(CONFIG_TCT_HOLI_BREMENVISIBLE)
	{1609,	-400},
	{1583,	-380},
	{1556,	-360},
	{1528,	-340},
