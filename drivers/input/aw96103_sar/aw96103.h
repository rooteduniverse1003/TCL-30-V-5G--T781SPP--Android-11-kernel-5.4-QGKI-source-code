...
*spereg cali flag
**********************************************/
enum aw96103_cali_flag {
	AW_NO_CALI = 0,
	AW_CALI = 1,
};

enum aw96103_ichannel { AW_CHANNEL0, AW_CHANNEL1, AW_CHANNEL2, AW_CHANNEL3, AW_CHANNEL4, AW_CHANNEL5, AW_CHANNEL_MAX,};

enum aw96103_irq_trigger_position { FAR, TRIGGER_TH0, TRIGGER_TH1 = 0x03, TRIGGER_TH2 = 0x07, TRIGGER_TH3 = 0x0f,};

/**********************************************
*spereg addr offset
**********************************************/
enum aw96103_spereg_addr_offset {
...
* @AW_TRIM_ERROR : trim is error.
**********************************************************/
enum aw96103_err_flags {
...
struct aw96103 {
	...
	struct aw96103_pinctrl pinctrl;
