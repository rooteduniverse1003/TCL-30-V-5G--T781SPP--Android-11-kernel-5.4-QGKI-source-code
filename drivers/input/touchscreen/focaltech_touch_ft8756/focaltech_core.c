...
// Begin added by lingchen for tp info node on 2020-01-21
//begin modify by bo_liu for gki
#if IS_ENABLED(CONFIG_TCT_DEVICE_INFO)
extern char ctpinfo[128];
#endif
//end modify by bo_liu for gki
...
//Begin added by lingchen for tp info node on 2021-01-21
//begin modify by bo_liu for gki
#if IS_ENABLED(CONFIG_TCT_DEVICE_INFO)
    snprintf(ctpinfo, 128, "FT8756:TDT");
#endif
//begin modify by bo_liu for gki
//End added by lingchen for tp info node on 2021-01-21
    FTS_FUNC_EXIT();
    return 0;
