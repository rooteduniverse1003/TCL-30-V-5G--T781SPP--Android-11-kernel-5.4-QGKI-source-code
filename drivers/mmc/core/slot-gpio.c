...
extern void card_detection_calibration(void);//modify by chen-liang for aw96105 calibration 2021/04/22
...
#endif
	#ifdef CONFIG_TCT_TRANSFORMERVZW_SAR
	card_detection_calibration();//modify by chen-liang for aw96105 calibration 2021/04/22
	#endif
