...
/*[FEATURE]-ADD-BEGIN GCSSZ.gaoxiang.zou, 02/21/2021, take slot can be see by app*/
/*cat sys/class/sdcard_device/sdcard_slot/slot_present 1 when card inserted*/

static struct mmc_host *slot_host;
static ssize_t sdcard_slot_show(struct device *dev, struct device_attribute *attr, char *buf)
{
        return snprintf(buf, PAGE_SIZE, "%u\n", mmc_gpio_get_cd(slot_host));
}


static DEVICE_ATTR(slot_present, 0644, sdcard_slot_show, NULL);
...
/*[FEATURE]-ADD-END GCSSZ.gaoxiang.zou*/
