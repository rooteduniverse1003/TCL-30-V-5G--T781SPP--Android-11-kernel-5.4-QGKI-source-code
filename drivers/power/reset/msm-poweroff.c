...
//Begin modified by lingchen for crashdump reason display on 2021-02-08
#include <soc/qcom/panic-reason.h>
//End modified by lingchen for crashdump reason display on 2021-02-08
...
// Task: 11607327, disable dload mode.
...
// Task: 11607327, set dload mode read only.
...
//begin: add by yange.zhang for task 9781354(smartlog), 2020-12-24
...
static int __init smartlogtoken_setup(char *__unused)
{
    ...
    pr_warning("smartlog always enable!\n");
    return 1;
}
__setup("androidboot.smartlogtoken=true", smartlogtoken_setup);
#endif
//end: add by yange.zhang for task 9781354(smartlog), 2020-12-24
