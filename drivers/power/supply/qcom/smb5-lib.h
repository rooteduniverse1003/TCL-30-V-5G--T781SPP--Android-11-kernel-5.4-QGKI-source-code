...
#define DOCK_CURRENT_UA			2050000 // weijun++
#endif
...
#define HVDCP3_CURRENT_UA		2050000
#else
...
/*start to add by weijun for charge current*/
#if defined(CONFIG_TCT_CHG_COMMON)
#define TYPEC_HIGH_CURRENT_UA		2050000
#else
#define TYPEC_HIGH_CURRENT_UA		3000000
#endif
/*end to add by weijun for charge current*/
...
#if defined(CONFIG_TCT_POGO)
	struct delayed_work	dock_otg_work; // weijun
#endif
...
/* Begin added by bitao.xiong for task-10699316 on 2021-02-03 */
	...
	struct delayed_work adapter_type_work;
#endif
#endif
...
#if defined(CONFIG_TCT_CHG_COMMON)
#if defined(CONFIG_TCT_HOLI_BREMENTF) || defined(CONFIG_TCT_HOLI_BREMENVISIBLE)
	int 		real_adapter_type;
	bool		real_adapter_type_done;
#endif
#endif
/* End added by bitao.xiong for task-10699316 on 2021-02-03 */
...
//end to add by weijun for dock_pin charge task-10658685
	...
	const char *tzone_name;//Add by zhikui.li for report quiet temperature
#endif
#endif
