...
//#add begin by jitao.bie for display boot failure info task10794932 on 2021/3/2
#ifdef TCT_SECURE_BOOT_FAILURE
		kernel_restart("dm-verity device corrupted");
#endif
//#add end by jitao.bie for display boot failure info task10794932 on 2021/3/2
		goto err_boot;
	}
