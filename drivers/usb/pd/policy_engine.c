...
#define PD_MAX_AUG_MAX_CURRENT	2000000
#define PD_MAX_AUG_MAX_VOLTAGE	10000000
#endif
...
#if defined(CONFIG_TCT_CHG_COMMON)
		if (ua > PD_MAX_AUG_MAX_CURRENT) {
			ua = PD_MAX_AUG_MAX_CURRENT;
		}
		if (uv > PD_MAX_AUG_MAX_VOLTAGE) {
			uv = PD_MAX_AUG_MAX_VOLTAGE;
		}
#endif
