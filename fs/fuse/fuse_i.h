...
extern int fuse_passthrough_enable;

static bool inline fuse_passthrough_workaround_enabled(struct fuse_conn *fc)
{
	return fuse_passthrough_enable && !fc->passthrough;
}
int fuse_passthrough_open2(struct fuse_dev *fud, struct fuse_req *req, int fd);
#endif
