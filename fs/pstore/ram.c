...
#endif
//end: modify by yange.zhang for task 9781354(smartlog), 2020-12-24
...
//begin: modify by yange.zhang for task 9781354(smartlog), 2020-12-24
...
static int notrace ramoops_pstore_write(struct pstore_record *record)
{
	...
	if (record->type != PSTORE_TYPE_DMESG)
		return -EINVAL;
////begin: modify by yange.zhang for task 9781354(smartlog), 2020-12-24
// we record more log, not only panic log
