...
#define klog_debug(fmt, ...) klog_print("debug", pr_fmt(fmt), ##__VA_ARGS__)
#define klog_info(fmt, ...) klog_print("info", pr_fmt(fmt), ##__VA_ARGS__)
#define klog_warn(fmt, ...) klog_print("warn", pr_fmt(fmt), ##__VA_ARGS__)
#define klog_err(fmt, ...) klog_print("err", pr_fmt(fmt), ##__VA_ARGS__)
