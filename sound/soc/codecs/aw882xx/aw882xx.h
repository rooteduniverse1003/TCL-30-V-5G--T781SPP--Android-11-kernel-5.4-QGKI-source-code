...
*/
#define AW882XX_SOFTWARE_RST_REG		(0x00)
#define AW882XX_SOFTWARE_RST_VALUE		(0x55AA)
...
enum aw882xx_mode_spk_rcv {
	...
	AW882XX_VOICEER_MODE = 2,
};

enum aw881xx_sync_mode {
	AW881XX_SYNC_OFF = 0,
	AW881XX_SYNC_ON,
};
...
struct aw882xx {
	...
	struct aw882xx_container *reg_cont;
